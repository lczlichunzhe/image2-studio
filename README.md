...
- 画幅比例选择：默认 `9:16` 竖版，也支持 `3:4`、`4:5`、`1:1`、`16:9`、自定义比例等
- 清晰度选择：`1K`、`2K`、`4K`
- 省钱模式 / 高清模式
- 输出格式：`png`、`jpeg`、`webp`
- 输出压缩、背景、审核强度、参考图保真度
...
新版不再直接让你选一堆固定尺寸，而是分成两步：

- `画幅比例`：决定图片形状，比如竖版 `9:16`、方图 `1:1`、横版 `16:9`
- `清晰度`：决定目标长边等级，比如 `1K`、`2K`、`4K`

默认是 `9:16 + 1K`，适合先快速出图测试。想要更清楚可以切到 `2K` 或 `4K`。

有些服务商不支持所有精确尺寸。程序会先使用服务商更容易兼容的接口尺寸生成，再把最终图片处理成你选择的画幅比例和清晰度。最终扣费规则仍以你的服务商账单为准。
